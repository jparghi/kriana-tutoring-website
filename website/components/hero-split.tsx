        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative w-fit">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative inline-flex w-fit max-w-[340px] items-center gap-2 overflow-hidden rounded-3xl bg-gradient-to-r from-red-600 via-orange-600 to-red-600 bg-[length:200%_auto] p-1.5 pr-4 shadow-[0_8px_28px_rgba(194,65,12,0.55)] transition-transform duration-300 animate-gradient-shift hover:scale-[1.03]"
            >
              {/* shine sweep */}
              ...
              <span className="flex h-9 shrink-0 items-center justify-center rounded-full bg-white px-2 shadow-md">
                <Image
              ...
              <span className="relative flex flex-col gap-0.5 text-xs font-extrabold leading-tight text-white">
                ...
                <span className="font-semibold text-white/80">powered by Young Engineers</span>
              </span>
            </a>
          </div>
