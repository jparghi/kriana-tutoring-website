...
export function ClipboardIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M5 4h14a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Z" />
...
export function SproutIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M14.1 6a7 7 0 0 1 3.9 4.9c-1.9.6-3.2.8-4.4.3-1.2-.5-2.4-1.6-3.2-4.1 2.2-.8 3.6-.7 3.7-.1z" />
    </svg>
  );
}
...
export function FlaskIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 2h6" />
      <path d="M10 2v6.34a2 2 0 0 1-.4 1.2L4.5 17.5A2 2 0 0 0 6 21h12a2 2 0 0 0 1.5-3.5l-5.1-8a2 2 0 0 1-.4-1.16V2" />
      <path d="M6.5 15h11" />
    </svg>
  );
}
